...
public class ImgToZpl {
    ...
    private static boolean compressHex = false;
    ...
    public static String convertFromImg(BufferedImage image) throws IOException {
    ...
    public static void setCompressHex(boolean compressHex) {
        compressHex = compressHex;
    }

    public static void setBlacknessLimitPercentage(int percentage) {
        blackLimit = (percentage * 768 / 100);
    }

    public static void main(String[] args) throws Exception {
        BufferedImage orginalImage = ImageIO.read(new File("D:\\work\\保定风帆\\501包装车间\\Doc\\test.jpg"));
        setCompressHex(true);
        setBlacknessLimitPercentage(50);
        System.out.println(convertFromImg(orginalImage));
    }
}
